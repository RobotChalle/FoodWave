	...
	<div class="container">
		<div class="input-form-backgroud row">
			<div class="input-form col-md-12 mx-auto">
				...
				<form method="post" action="inputSave"
					onsubmit="return checkValue()">
					<div class="row">
						<div class="col-md-6 mb-3">
							<label >작성자</label> <input type="text"
								class="form-control" name="username"
								maxlength="50" placeholder="작성자를 입력해주세요" required>
						</div>
						<div class="col-md-6 mb-3">
							<label >여행지</label> <input type="text"
								class="form-control" name="place" placeholder="여행지를 입력해주세요"
								required>
						</div>
					</div>
					<div class="row">
						<div class="col-md-6 mb-3">
							<label>맛집 이름</label> <input type="text"
								class="form-control" name="restaurant" placeholder="맛집 이름을 입력해주세요"
								required>
						</div>
					</div>
					<div class="row">
					<textarea class="col-md-6 mb-3"
						name="review" placeholder="리뷰 내용" rows="3" required></textarea>
					</div>
					<button class="btn btn-primary btn-lg btn-block" type="submit">입력
						완료</button>
				</form>
			</div>
		</div>
